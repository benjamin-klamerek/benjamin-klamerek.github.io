...
Rule1 + ON Button1#state DO event close ENDON
Rule1 + ON RfReceived#Data=0x82422 DO event close ENDON
...
Rule2 + ON Button2#state DO event open ENDON
Rule2 + ON RfReceived#Data=0x82421 DO event open ENDON
...
![pcbv1.jpg]({% link IOT_projects/roller_shutters/global_remote_controller/pcbV1.png %})
